import fs from 'fs';
import { CARDANO_CLI, CARDANO_NETWORK_TYPE, HOURS_BEFORE_CONTRACT_EXPIRES } from '../global';
...
(() => {
    ...
    fs.writeFileSync(`${__dirname}/policy/policy.script`, JSON.stringify(policy_script));
    ...
    fs.writeFileSync(`${__dirname}/policy/policyID`, policy_id.replace("\r", "").replace("\n", ""));
